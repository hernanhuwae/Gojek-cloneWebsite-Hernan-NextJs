        ...
        <div className="flex flex-col">
              ...
              <div className="drawer drawer-end">
                ...
                <div className="drawer-side ">
                  ...
                  <ul className="menu p-4 w-80 min-h-full text-center text-base-content bg-[#101820]">
                    ...
                    <li className="text-[1.3rem] font-semibold hover:underline cursor-pointer text-white my-4">
          ...
          <div className="w-full h-screen  bg-white flex flex-col">
            <div className="h-[150PX]  border-white w-full bg-[#101820] flex justify-center items-center ">
              <h1 className="text-white font-extrabold text-[50px]">
                MILESTONE
              </h1>
            </div>
          ...
          <div className="flex h-auto bg-[#011f4b] items-center gap-4 max-md:flex-col">
            ...
            >
              ...
              <p className="m-8 text-center text-wrap text-[#FBF3D5] text-[18px]">
                ...
                School. Ide mendirikan Gojek muncul dari pengalaman pribadi
                Nadiem Makarim menggunakan transportasi ojek hampir setiap hari
          ...
          <h1 className="text-[50px] py-8 font-bold text-[#F7EEDD] text-center bg-[#101820]">
            DIVISION TEAMS
          </h1>

          <div className="flex h-auto items-center gap-4 max-md:flex-col bg-[#101820]">
            <Image
              data-aos="zoom-in"
              className="rounded-full p-8 w-[450px] h-[400px] mx-12"
              src={bggojek}
                  ...
                  <li>
                    ...
                    <div className="timeline-end mb-10">
                      ...
                      <p className="text-white">
                        {" "}
                        Lee lahir di Heukseuk-dong, Dongjak-gu, Seoul. Ketika
                        masih kecil, Lee Min-ho bercita-cita untuk menjadi
                        seorang pemain sepak bola profesional. Ia dipilih ke
                        dalam kelas sepak bola khusus pemuda oleh mantan pemain
                        profesional Cha Bum-kun, tetapi saat kelas 5 sekolah
                        dasar, ia mengalami cidera dan terpaksa harus mengubur
                        mimpinya untuk menjadi pemain sepak bola sejak saat
                        itu.[1] Pada tahun kedua SMA-nya, Lee Min-ho mulai
