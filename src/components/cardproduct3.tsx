...
export const CardProduct3: React.FC<ICardProduct> = ({
  item1,
  item2,
  item3,
  item4,
  ...
  return (
    <>
      {/* PRODUK 1 */}
      <div data-aos="zoom-in"  data-aos-duration="1200" className="flex flex-col bg-[#ee2737] rounded-[15%] min-w-[200px] min-h-[50px] w-[25%]">
        ...
        <div className="px-4 bg-[#c93d49c4] rounded-b-[15%]">
