...
export const CardProduct2: React.FC<ICardProduct> = ({
  item1,
  item2,
  item3,
  item4,
  ...
  return (
    <>
      {/* PRODUK 1 */}
      <div data-aos="zoom-in"  data-aos-duration="1200" className="flex flex-col bg-[#00aed6] rounded-[15%] min-w-[200px] min-h-[50px] w-[25%]">
        ...
        <div className="px-4 bg-[#297889] rounded-b-[15%]">
