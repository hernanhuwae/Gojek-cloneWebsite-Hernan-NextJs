    ...
    <>
      <div className="w-full min-w-[500px] bg-[#101820]">
        ...
        <div className="min-w-[500px] h-screen">
          ...
          <div className="flex justify-center max-lg:flex-wrap gap-4 px-8 min-w-[500px] py-8 bg-[#101820]">
            <CardProduct
              item1="GoRide"
              item2="GoCar"
              item3="GoBluebird"
          ...
          <div className="flex flex-col justify-center items-center bg-[#101820]">
            <h1
              data-aos="fade-in"
              data-aos-duration="1100"
              className="text-white text-[30px] my-3 font-extrabold"
            >
              LOYALTY GOJEK PRODUK
            </h1>
            <p
              data-aos="zoom-in"
              data-aos-duration="1500"
              className="text-white text-[18px] mb-5"
            >
              Make more transactions, get more rewards!
            </p>
            <IButton
              data-aos="zoom-in"
              data-aos-duration="1500"
